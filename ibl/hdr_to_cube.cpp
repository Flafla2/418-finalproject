...
*/
	...
	for (uint32_t f = 0; f < 6; ++f) {
		...
		if      (f == PositiveX) { tc =-glm::vec3( 0.0f, 0.0f,-1.0f); sc =-glm::vec3( 0.0f,-1.0f, 0.0f); ma = glm::vec3( 1.0f, 0.0f, 0.0f); }
		else if (f == NegativeX) { tc = glm::vec3( 0.0f, 0.0f, 1.0f); sc = glm::vec3( 0.0f,-1.0f, 0.0f); ma = glm::vec3(-1.0f, 0.0f, 0.0f); }
		...
		else if (f == PositiveZ) { tc = glm::vec3( 1.0f, 0.0f, 0.0f); sc = glm::vec3( 0.0f,-1.0f, 0.0f); ma = glm::vec3( 0.0f, 0.0f, 1.0f); }
